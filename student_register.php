<?php
  ...
  try {
    ...
    if (isset($_POST['done'])) {
      ...
      $insert = $conn->prepare("INSERT INTO students (`fullname`, `regno`, `email`, `phone`, `password`) VALUES (:fullname, :regno, :email, :phone, :password)");
          ...
          <div class="row w-100">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <h3> Student Registration section</h3>
